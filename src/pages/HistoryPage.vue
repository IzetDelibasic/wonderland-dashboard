<template>
  <div :style="{ backgroundImage: 'url(' + require('@/images/dashboardBackground.webp') + ')', backgroundSize: 'cover' }" class="min-h-screen">
    ...
    <div class="w-[80%] flex flex-col justify-center items-center mx-auto mt-[3rem] bg-white bg-opacity-80 rounded-[30px] rounded-bl-none rounded-tr-none hover:bg-opacity-45 hover:rounded-[30px] ease-in-out duration-300 p-[5rem]">
      ...
      <div class="flex lg:flex-row flex-col justify-between lg:w-[50%] w-full pt-[7.5rem]">
